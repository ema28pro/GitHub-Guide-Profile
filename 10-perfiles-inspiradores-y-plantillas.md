...
<table border="0">
  ...
  <tr>
    <td align="center">
      <p><b>Completa y Moderna</b></p>
      <p>Typing SVG animado, badges de redes, stack tecnológico categorizado por capas, proyectos en tabla comparativa y métricas.</p>
      <br/>
      <a href="./plantillas/plantilla-fullstack.md"><strong>👉 Ver Plantilla Full-Stack</strong></a>
    </td>
    <td align="center">
      <p><b>Limpia y Sobria</b></p>
      <p>Centrada en tipografía de alta calidad, enlaces directos, experiencia y proyectos seleccionados sin sobrecarga visual.</p>
      <br/>
  ...
  <tr>
    <td align="center">
      <p><b>Científica y de Datos</b></p>
      <p>Badges para Kaggle, HuggingFace y Google Scholar, stack de Machine Learning/MLOps y proyectos de análisis predictivo.</p>
      <br/>
      <a href="./plantillas/plantilla-data-ia.md"><strong>👉 Ver Plantilla Data Science</strong></a>
    </td>
    <td align="center">
      <p><b>Formativa y de Crecimiento</b></p>
      <p>Enfocada en metas de aprendizaje, tecnologías dominadas vs en estudio, proyectos de práctica y llamado al contacto laboral.</p>
      <br/>
...
mindmap
  root((Perfil de Alto Impacto))
    ...
    Experiencia Técnica
      Stack clasificado
      Proyectos con Live Demo
      Código testeable
    Estética y Balance
      Paleta de color armónica
      Sin sobrecarga de widgets
